...
var j = class {
  ...
  get_layer_bounds(e5) {
    let t2 = x(e5, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), n3 = v;
    return f.dotlottieplayerwasm_get_layer_bounds(this.__wbg_ptr, t2, n3);
  }
  get_pixel_buffer() {
  ...
  intersect(e5, t2, n3) {
    let r3 = x(n3, f.__wbindgen_malloc_command_export, f.__wbindgen_realloc_command_export), i3 = v;
    return f.dotlottieplayerwasm_intersect(this.__wbg_ptr, e5, t2, r3, i3) !== 0;
  }
  is_loaded() {
...
function q(e5, t2, n3) {
  let r3 = null, i3 = t2;
  return { load() {
    return r3 || (r3 = e5({ module_or_path: i3 }).then(() => void 0).catch(async (t3) => {
      console.warn(`Primary WASM load failed from ${i3}: ${t3.message}`), console.warn(`Attempting to load WASM from backup URL: ${n3}`);
      try {
        await e5({ module_or_path: n3 });
      } catch (e6) {
        throw console.error(`Primary WASM URL failed: ${t3.message}`), console.error(`Backup WASM URL failed: ${e6.message}`), r3 = null, Error(`WASM loading failed from all sources.`);
      }
    })), r3;
  }, setWasmUrl(e6) {
    e6 !== i3 && (i3 = e6, r3 = null);
...
var ae = class {
  constructor(e5) {
    ...
    r(this, `_canvas`, null), r(this, `_pendingLoad`, null), r(this, `_context`, null), r(this, `_eventManager`, void 0), r(this, `_animationFrameId`, null), r(this, `_frameManager`, void 0), r(this, `_dotLottieCore`, null), r(this, `_stateMachineId`, ``), r(this, `_stateMachineConfig`, null), r(this, `_isStateMachineRunning`, false), r(this, `_renderConfig`, {}), r(this, `_isFrozen`, false), r(this, `_backgroundColor`, null), r(this, `_boundOnClick`, null), r(this, `_boundOnPointerUp`, null), r(this, `_boundOnPointerDown`, null), r(this, `_boundOnPointerMove`, null), r(this, `_boundOnPointerEnter`, null), r(this, `_boundOnPointerLeave`, null), r(this, `_bufferMismatchCount`, 0), r(this, `_lastExpectedBufferSize`, 0), r(this, `_marker`, ``), this._canvas = e5.canvas ?? null, this._eventManager = new I(), this._frameManager = new o(), this._renderConfig = { ...e5.renderConfig, devicePixelRatio: ((_a = e5.renderConfig) == null ? void 0 : _a.devicePixelRatio) || U(), freezeOnOffscreen: ((_b = e5.renderConfig) == null ? void 0 : _b.freezeOnOffscreen) ?? true }, this._initWasm().then(() => {
      ...
      this._dotLottieCore = this._createCore(), this._dotLottieCore.set_autoplay(e5.autoplay ?? false), this._dotLottieCore.set_loop(e5.loop ?? false), this._dotLottieCore.set_loop_count(e5.loopCount ?? 0), this._dotLottieCore.set_mode(Y(e5.mode ?? `forward`)), this._dotLottieCore.set_speed(e5.speed ?? 1), this._dotLottieCore.set_use_frame_interpolation(e5.useFrameInterpolation ?? true), e5.segment && e5.segment.length === 2 && this._dotLottieCore.set_segment(e5.segment[0], e5.segment[1]), this._marker = e5.marker ?? ``, this._marker && this._dotLottieCore.set_marker(this._marker), this._dotLottieCore.set_layout(((_a2 = e5.layout) == null ? void 0 : _a2.fit) ?? `contain`, ((_c = (_b2 = e5.layout) == null ? void 0 : _b2.align) == null ? void 0 : _c[0]) ?? 0.5, ((_e = (_d = e5.layout) == null ? void 0 : _d.align) == null ? void 0 : _e[1]) ?? 0.5), this._stateMachineId = e5.stateMachineId ?? ``, this._stateMachineConfig = e5.stateMachineConfig ?? null, this._onCoreCreated(), this._eventManager.dispatch({ type: `ready` }), e5.data ? this._canvas ? this._loadFromData(e5.data) : this._pendingLoad = { data: e5.data } : e5.src && (this._canvas ? this._loadFromSrc(e5.src) : this._pendingLoad = { src: e5.src }), e5.backgroundColor && this.setBackgroundColor(e5.backgroundColor);
    }).catch((e6) => {
  ...
  _drainSmEvents() {
    ...
    for (; (t2 = this._dotLottieCore.sm_poll_internal_event()) != null; ) {
      ...
      if (e6.type === `Message`) {
        let t3 = e6.message ?? ``;
        s && t3.startsWith(`OpenUrl: `) ? K(t3) : this._eventManager.dispatch({ type: `stateMachineInternalMessage`, message: t3 });
      }
    }
  }
  _dispatchError(e5) {
  ...
  async _fetchData(e5) {
    ...
    return B(n3) ? n3 : new TextDecoder().decode(n3);
  }
  _loadFromData(e5) {
    ...
    r3 ? (this._renderConfig.quality !== void 0 && this._dotLottieCore.set_quality(this._renderConfig.quality), s && this.resize(), this._drainPlayerEvents(), this._marker && this._dotLottieCore.set_marker(this._marker), setTimeout(() => {
  ...
  _draw() {
    if (!(this._dotLottieCore === null || this._canvas === null) && (!this._context && `getContext` in this._canvas && typeof this._canvas.getContext == `function` && (typeof HTMLCanvasElement < `u` && this._canvas instanceof HTMLCanvasElement || typeof OffscreenCanvas < `u` && this._canvas instanceof OffscreenCanvas) && (this._context = this._canvas.getContext(`2d`)), this._context)) {
      ...
      let n3 = null, r3 = new Uint8ClampedArray(e5.buffer, e5.byteOffset, e5.byteLength);
      typeof ImageData > `u` ? (n3 = this._context.createImageData(this._canvas.width, this._canvas.height), n3.data.set(r3)) : n3 = new ImageData(r3, this._canvas.width, this._canvas.height), this._context.putImageData(n3, 0, 0);
    }
  }
  _cleanupCanvas() {
  ...
  setColorSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
    let n3 = this._isKeyframeArray(t2), r3 = JSON.stringify({ a: n3 ? 1 : 0, k: t2 }), i3 = this._dotLottieCore.set_slot_str(e5, r3);
    return this._dotLottieCore.render(), this._draw(), i3;
  }
  setScalarSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
    let n3 = typeof t2 != `number`, r3 = JSON.stringify({ a: n3 ? 1 : 0, k: t2 }), i3 = this._dotLottieCore.set_slot_str(e5, r3);
    return this._dotLottieCore.render(), this._draw(), i3;
  }
  setVectorSlot(e5, t2) {
    if (this._dotLottieCore === null) return false;
  ...
  setGradientSlot(e5, t2, n3) {
    if (this._dotLottieCore === null) return false;
    let r3 = this._isKeyframeArray(t2), i3 = JSON.stringify({ k: { a: r3 ? 1 : 0, k: t2 }, p: n3 }), a3 = this._dotLottieCore.set_slot_str(e5, i3);
...
var $ = class e4 {
  ...
  async _create(e5) {
    ...
    let { instanceId: n3 } = await this._sendMessage(`create`, { instanceId: this._id, config: { ...e5, canvas: t2 }, ...Z(this._canvas, ((_a = e5.renderConfig) == null ? void 0 : _a.devicePixelRatio) || U()) }, [t2]);
  ...
  async play() {
    this._created && (await this._sendMessage(`play`, { instanceId: this._id }), await this._updateDotLottieInstanceState(), s && this._canvas instanceof HTMLCanvasElement && this._dotLottieInstanceState.renderConfig.freezeOnOffscreen && !W(this._canvas) && await this.freeze());
  }
  async pause() {
  ...
  async setRenderConfig(e5) {
    ...
    let { devicePixelRatio: t2, freezeOnOffscreen: n3, quality: r3, ...i3 } = e5;
    await this._sendMessage(`setRenderConfig`, { instanceId: this._id, renderConfig: { ...this._dotLottieInstanceState.renderConfig, ...i3, devicePixelRatio: t2 || U(), freezeOnOffscreen: n3 ?? true, ...r3 !== void 0 && { quality: r3 } } }), await this._updateDotLottieInstanceState(), s && this._canvas instanceof HTMLCanvasElement && (this._dotLottieInstanceState.renderConfig.autoResize ? R.observe(this._canvas, this) : R.unobserve(this._canvas), this._dotLottieInstanceState.renderConfig.freezeOnOffscreen ? (L.observe(this._canvas, this), W(this._canvas) || await this.freeze()) : (L.unobserve(this._canvas), this._dotLottieInstanceState.isFrozen && await this.unfreeze()));
  }
  ...
  async resize() {
    ...
    let { height: e5, width: t2 } = Z(this._canvas, this._dotLottieInstanceState.renderConfig.devicePixelRatio || U());
    await this._sendMessage(`resize`, { height: e5, instanceId: this._id, width: t2 }), await this._updateDotLottieInstanceState();
  }
  async destroy() {
    this._created && (this._created = false, await this._sendMessage(`destroy`, { instanceId: this._id }), this._cleanupStateMachineListeners(), e4._workerManager.unassignAnimationFromWorker(this._id), this._eventManager.removeAllEventListeners(), s && this._canvas instanceof HTMLCanvasElement && (L.unobserve(this._canvas), R.unobserve(this._canvas)));
  }
  async freeze() {
  ...
  async _sendMessage(e5, t2, n3) {
    let r3 = { id: `dotlottie-request-${Q()}`, method: e5, params: t2 };
    return this._worker.postMessage(r3, n3 || []), new Promise((t3, n4) => {
      let i3 = (a3) => {
        let o3 = a3.data;
        o3.id === r3.id && (this._worker.removeEventListener(`message`, i3), o3.error ? n4(Error(`Failed to execute method ${e5}: ${o3.error}`)) : t3(o3.result));
      };
      this._worker.addEventListener(`message`, i3);
    });
  }
  addEventListener(e5, t2) {
    this._eventManager.addEventListener(e5, t2);
